...
class ServerView(View):
    ...
    def draw(self, ctx):
        pygame.draw.rect(ctx, self.COLORS[self.model.assigned_task is not -1], pygame.Rect(self.position[0], self.position[1],100,100))
        x = self.position[1]
        ...
        x = (x + 1) * 30
        string = "Task {}".format(self.model.assigned_task)
        text = self.font.render(string, True, WHITE)
